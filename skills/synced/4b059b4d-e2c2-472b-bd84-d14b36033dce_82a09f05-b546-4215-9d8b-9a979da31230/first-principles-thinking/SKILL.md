...
description: "Use when the user asks to analyze from first principles, think from scratch, question a design (\"is this the right approach\", \"is this design reasonable\", \"why are we doing it this way\", \"is there a better solution\"), challenge assumptions, or needs to evaluate architectural decisions, design choices, or problem-solving approaches without relying on analogies or conventions."
---
